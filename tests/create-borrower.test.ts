...
function createBorrowerId(proxyCometAddress: Address, userAddress: Address): Bytes {
  return Bytes.fromHexString(proxyCometAddress.toHexString() + userAddress.toHexString());
}

describe("createBorrower tests", () => {
  beforeAll(() => {
    let proxyCometAddress = Address.fromString("0x0000000000000000000000000000000000000001");
